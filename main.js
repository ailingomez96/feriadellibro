...
function nuestrasRecomendaciones() {
    ...
    if (categoria && subgenero) {
        ...
        localStorage.setItem('informacionUsuario', infoJSON);

        console.log("Información almacenada:", infoJSON);

        alert("Información almacenada: " + infoJSON);
    } else {
        alert("Por favor, ingresa tanto la categoría como el subgénero.");
    }
}
